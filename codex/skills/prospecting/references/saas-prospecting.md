...
- **GitHub stars/forks of competitor or adjacent repos**: developer-level intent signal (see the pinned [GitHub integration guide](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/integrations/github.md)). Especially strong for dev-tool SaaS — a developer who starred `vercel/next.js` last week is in-market for adjacent Next.js infrastructure.
...
2. Pull public stargazer data (or forks for a stronger signal) through an available GitHub connector or the public GitHub API. Enrich only from authorized, compliant sources.
