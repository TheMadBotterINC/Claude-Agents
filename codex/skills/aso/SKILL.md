...
Use the available web browsing or page-opening capability to retrieve the listing page. Extract every available field:
...
If the page retrieval is incomplete because the store renders client-side,
note the gaps and work with what's available. Use a configured JavaScript-capable
browser when available; otherwise ask the user to paste critical missing fields.

### Visual asset assessment

Static page retrieval may not expose screenshot images or caption text. **Use a
configured browser to take a screenshot of the listing page** when visual data
is needed:
...
3. If browser capability is unavailable, ask the user to share a screenshot of the
   listing page
