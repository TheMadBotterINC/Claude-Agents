...
|---|---|---|
| **Account performance** | Winners/losers by angle, hook, format; funnel metrics per concept (see [hook-system.md](hook-system.md) diagnostic funnel); fatigue state | Configured read-only ads connector or a user-provided platform export (see Tool Integrations in SKILL.md) |
