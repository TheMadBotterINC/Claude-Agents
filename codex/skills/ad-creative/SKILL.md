...
For pulling performance data, use a configured read-only connector or a user-provided export. The pinned upstream [tools registry](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/REGISTRY.md) documents optional integrations. Treat campaign creation, uploads, status changes, and budget changes as separate external mutations that require explicit authorization.

| Platform | Read-only data to request | Guide |
|----------|---------------------------|-------|
| **Google Ads** | Campaign, ad, conversion, and spend reports | [google-ads.md](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/integrations/google-ads.md) |
| **Meta Ads** | Campaign/ad-set insights and creative breakdowns | [meta-ads.md](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/integrations/meta-ads.md) |
| **LinkedIn Ads** | Campaign analytics and creative performance | [linkedin-ads.md](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/integrations/linkedin-ads.md) |
| **TikTok Ads** | Campaign and creative performance reports | [tiktok-ads.md](https://github.com/coreyhaines31/marketingskills/blob/130847d0945555c43b0b1774e2a4f99d35a32ebe/tools/integrations/tiktok-ads.md) |

### Workflow: Pull Data, Analyze, Generate

1. Pull or request a recent read-only performance export.
2. Identify top and bottom performers with enough delivery to compare.
3. Feed grounded winning patterns into this skill.
4. Generate new variations as staged artifacts.
5. Upload or publish only when the user explicitly authorizes that external action.
